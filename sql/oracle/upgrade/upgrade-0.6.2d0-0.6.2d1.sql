...
BEGIN
  SELECT count(*) into v_column_exists
    from user_tab_cols
    where column_name = 'ACS_EVENTS'
      and table_name = 'LOCATION';

  IF (v_column_exists = 0) then
      execute immediate 'ALTER TABLE acs_events ADD COLUMN location varchar2(255)';
  END IF;
END;
/

--
-- create acs_attribute
--
DECLARE 
...
--
-- regnerate the view, since e.* will return an additional attribute
--
...
--
-- replace the Oracle package 'acs_event' with updated .new() and
