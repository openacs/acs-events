...
by W. Scott Meeks
<h3>I. Introduction</h3><p>This document records the requirements for a new ACS Events
...
can be associated with an arbitrary number of ACS objects.</p><h3>II. Vision Statement</h3><p>The ACS Events package will provide support for other services
...
reservations, event registration, and possibly workflow.</p><p>The service needs to support recurring events. Many applications
...
provide for custom recurrences.</p><p>Having a single service for this functionality provides a number
of business advantages:</p><ul>
...
</ul><p>For example, the events service could support a room reservation
...
calendar item.</p><h3>III. ACS Events Package Overview</h3><p>There are four main areas of functionality in the events
package: events, time intervals, activities, and recurrences. The
service depends upon the ACS object and parties systems.</p><h4>III.A Events</h4><p>An <b>event</b> is an activity associated with a temporal
...
indicating when that activity is to occur.</p><p>An event can optionally be mapped to a set of parties
representing groups or individuals that have some connection to the
event.</p><p>The service provides an API for manipulating events.</p><p>An event is a relationship which maps parties and an activity to
...
ended.</p><p>Activities contain a name, a description, and an optional link
...
activity or event.</p><h4>III.B Time Interval Sets</h4><p>A time interval set is a range of moments at which an event can
...
time interval set.</p><p>The service provides an API for manipulating time interval
sets.</p><h4>III.C Activities</h4><p>An <b>activity</b> is a thing that a person or people do,
...
<h4>III.D Recurring Events</h4><p>Consider an event, say, an activity A performed on day D at time
...
end dates of recurrences can be uniformly offset.</p><h4>III.E Dependencies</h4><p>The service depends on the ACS object model and on our parties
...
and an arbitrary number of parties.</p><h3>IV. Use-cases and User-scenarios</h3><p><i>Determine the types or classes of users who would use the
...
would take, and how the system would support them.</i></p><h3>V. Related Links</h3><ul>
...
but does not yet have a set time.</p><p><b>10.30 Activities</b></p><p>
<b>10.30.10</b> An activity has a name and a description.</p><p>
...
or project management.</p><p><b>10.50 Recurring Events</b></p><p>
<b>10.50.10</b> The data model provides a table which describes
how to generate recurrences from a base event.</p><b>10.50.20</b> Recurring on a daily basis should be supported.
<p>
...
on those recurrences that aren't fully populated in the DB.</p><h3>VI.B API Requirements</h3><p><b>20.10 Event API</b></p><p>
<b>20.10.10</b> The service supports adding an event.</p><p>
...
mapping to an event.</p><p>
<b>20.10.40</b> The service supports deleting a complete
event.</p><p><b>20.20 Time Interval Set API</b></p><p>
...
dates of a time interval.</p><p>
<b>20.20.40</b> The service supports deleting a time interval
from a set.</p><p>
<b>20.20.50</b> The service supports counting the number of time
intervals in a set.</p><p>
<b>20.20.60</b> The service supports determining if a given
interval overlaps a particular time interval set.</p><p><b>20.30 Activity API</b></p><p>
<b>20.30.10</b> The service supports creating an activity.</p><p>
<b>20.30.20</b> The service supports deleting an activity.</p><p>
...
object mapping to an event.</p><p><b>20.50 Recurrence API</b></p><p>
...
recurs.</p><h3>VII. Design and Implementation Notes</h3><h4>VII.A 3.4 Calendar Package</h4><p>The <a href="http://www.arsdigita.com/doc/calendar/">3.4
...
recurring items.</p><h4>VII.B Problem Set 2</h4><p>Another way to look at this events service is as an elaboration
...
be split out into separate mapping tables.</p><h4>VII.C Recurring Events</h4><p>There is a very important tradeoff to be made in the
...
calendar package.</p><p>There are two main choices for supporting recurring events. One
...
for each recurrence.</p><p>I favor the second approach for the following reasons. First,
...
recurrence.</p><p>Another reason is that the first approach, to insert only a
...
be greater.</p><p>This approach will also make it much easier to handle exceptions
to recurrences and individualizing the objects associated with
instances of events.</p><p>However, there are drawbacks to this approach. First, it will be
...
swamping the database.</p><p>Another issue is that when populating the DB with recurring
...
individually.</p><h3>VIII. Revision History</h3><table cellpadding="2" cellspacing="2" width="90%" bgcolor="#EFEFEF">
<tr bgcolor="#E0E0E0">
...
</table><hr><address><a href="mailto:smeeks\@arsdigita.com">smeeks\@arsdigita.com</a></address>
Last modified: $Date$
</body>
